...
Route::get('/registrar','UsuarioController@register')->name('registrar.app');
Route::post('/registrarcliente','UsuarioController@registerclienteapp')->name('registrar.clienteapp');
...
Route::prefix('mapapp')->group(function() 
{
  Route::get('/','MapaController@indexapp')->name('mapapp.index')->middleware('auth');
});
...
{
  Route::get('/','ConductorController@index')->name('conductor.index')->middleware('auth');
  Route::get('/getTable', 'ConductorController@getTable')->name('conductor.getTable')->middleware('auth');
  Route::get('/getTabledispositivos/{id}', 'ConductorController@getTable_dispositivo')->name('conductor.getTabledispositivo');
  Route::get('/registrar', 'ConductorController@create')->name('conductor.create')->middleware('auth');
  Route::post('/registrar', 'ConductorController@store')->name('conductor.store')->middleware('auth');
  Route::get('/actualizar/{id}', 'ConductorController@edit')->name('conductor.edit')->middleware('auth');
  Route::put('/actualizar/{id}', 'ConductorController@update')->name('conductor.update')->middleware('auth');
  Route::get('/datos/{id}', 'ConductorController@show')->name('conductor.show')->middleware('auth');
  Route::get('/destroy/{id}', 'ConductorController@destroy')->name('conductor.destroy')->middleware('auth');
  Route::post('/getDocumento', 'ConductorController@getDocumento')->name('conductor.getDocumento');

}); 
Route::prefix('vehiculo')->group(function()
{
  Route::get('/','VehiculoController@index')->name('vehiculo.index')->middleware('auth');
  Route::get('/getTable', 'VehiculoController@getTable')->name('vehiculo.getTable')->middleware('auth');
  Route::get('/registrar', 'VehiculoController@create')->name('vehiculo.create')->middleware('auth');
  Route::post('/registrar', 'VehiculoController@store')->name('vehiculo.store')->middleware('auth');
  Route::get('/actualizar/{id}', 'VehiculoController@edit')->name('vehiculo.edit')->middleware('auth');
  Route::put('/actualizar/{id}', 'VehiculoController@update')->name('vehiculo.update')->middleware('auth');
  Route::get('/destroy/{id}', 'VehiculoController@destroy')->name('vehiculo.destroy')->middleware('auth');
  Route::post('/getDocumento', 'VehiculoController@getDocumento')->name('vehiculo.getDocumento');
});
Route::prefix('carrera')->group(function()
{
  Route::get('/','CarreraController@index')->name('carrera.index')->middleware('auth');
  Route::get('/getTable', 'CarreraController@getTable')->name('carrera.getTable')->middleware('auth');
  Route::get('/registrar', 'CarreraController@create')->name('carrera.create')->middleware('auth');
  Route::post('/registrar', 'CarreraController@store')->name('carrera.store')->middleware('auth');
  Route::get('/actualizar/{id}', 'CarreraController@edit')->name('carrera.edit')->middleware('auth');
  Route::post('/actualizar', 'CarreraController@actualizar')->name('carrera.actualizar')->middleware('auth');
  Route::get('/destroy/{id}', 'CarreraController@destroy')->name('carrera.destroy')->middleware('auth');
  Route::get('/consulta', 'CarreraController@consulta')->name('carrera.consulta')->middleware('auth');
  Route::post('/consultacarrera','CarreraController@consultarcarreras')->name('carrera.consultarcarreras');
  Route::post('/consultacarrerapdf','CarreraController@consultarcarreraspdf')->name('carrera.consultarcarreraspdf');
});


//api 
Route::get('/api/registroapp','UsuarioController@registerapp');
Route::get('/api/puntuacion','CarreraController@puntuacion');
// 
