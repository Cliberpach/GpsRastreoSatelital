         ...
         <div>
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                <button type="button" class="btn btn-primary block full-width m-b btn-margin-sesion" onclick="registrarcarrera()">Registrar</button>
              </div>
     ...
     function initMap() {
       polygon = new google.maps.Polygon();
          ...
          const legend = document.getElementById("carrera");
                   ...
                   image.url = markers.length===0 ? "https://aseguroperu.com/img/e.png" :" https://aseguroperu.com/img/gpa_red.png";
                     var marker=  new google.maps.Marker({
                             ...
                             var direccion="";
                             $.ajax({
                                           url: 'https://maps.googleapis.com/maps/api/geocode/json?latlng='+marker.getPosition().lat()+','
                                                 +marker.getPosition().lng()+'&key=AIzaSyAS6qv64RYCHFJOygheJS7DvBDYB0iV2wI', 
                                           type: 'GET',
                                           async: false,
                                           success: function(res) {
                                           direccion=res.results[0].formatted_address;
                             ...
                             {
                                             $("#direccion_actual").val(direccion);
                                             $("#latinicial").val(marker.getPosition().lat());
                                             $("#lnginicial").val(marker.getPosition().lng());
                                         ...
                                         else
                                         {
                                             ...
                                             $("#latfinal").val(marker.getPosition().lat());
                                             $("#lngfinal").val(marker.getPosition().lng());
                                         }
                             markers.push(marker);
                    }
